...
class TestReverse < MiniTest::Unit::TestCase
	...
	def test_1
		assert_equal [1, 2, 3, 4, 5], reverse(1, [1, 2, 3, 4, 5])      
	end

	def test_2
		assert_equal [2, 1, 3, 4, 5], reverse(2, [1, 2, 3, 4, 5])      
	end

	def test_3
		assert_equal [5, 4, 3, 2, 1], reverse(5, [1, 2, 3, 4, 5])
	end

	def test_4
		assert_equal [12, 41, 51, 62, 74], reverse(3, [51, 41, 12, 62, 74]) 
	end
